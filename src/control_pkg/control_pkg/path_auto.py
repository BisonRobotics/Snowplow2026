...
class PathAuto(Node):
    ...
    def update_waypoints(self):
        ...
        if internal_cone % 2 == 1:
            ...
            self.right_waypoint = self.waypoint_array[internal_cone + 1] # !!!! this Is SUS please fix if broken
    ...
    def determine_control(self):
        ...
        match self.state:
            case 0:
                ...
                return
            case 1:
                self.get_logger().info('center push clear')
                self.drive_distance(1, 5)
                return
            case 2:
                ...
                return
            case 3:
                self.get_logger().info('comming back to garage of the path')
                self.drive_distance(-1, 4)
                return
            case 4:
                self.get_logger().info('waiting for 2 seconds')
                self.wait_time(2)
